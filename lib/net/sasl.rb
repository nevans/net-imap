...
module Net
  ...
  # Pluggable mechanisms for protocols which use SASL (Simple Authentication and
  # Security Layer).  From RFC4422[https://tools.ietf.org/html/rfc4422]: "SASL is
  ...
  module SASL
    ...
    def self.add_authenticator(*args, **kwargs, &block)
      Registry::GLOBAL.add_authenticator(*args, **kwargs, &block)
    end
    ...
    def self.authenticator(mechanism, *args, **kwargs, &block)
      Registry::GLOBAL.authenticator(mechanism, *args, **kwargs, &block)
    end
